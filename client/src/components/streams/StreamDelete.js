...
class StreamDelete extends React.Component {
  ...
  renderActions() {
    ...
    return (
      // React.Fragment - with the help of this, we can pass in multiple JSX wrapped inside, without error
      // but styling will not be affected, as this wil not be rendered
      <React.Fragment>
